...
const frontend=fs.readFileSync(path.join(root,'assets/js/marketing-opportunity-engine-v6.js'),'utf8'),index=fs.readFileSync(path.join(root,'index.html'),'utf8');assert(frontend.includes('result.opportunities||result.records||[]'));assert(index.includes('marketing-opportunity-engine-v6.js?v=20260826-3'));
