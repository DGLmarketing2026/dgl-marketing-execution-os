...
assert(engine.includes('opportunities:v6Rows_'));assert(engine.includes('v6PipelineSyncSignals_({opportunities:opportunities})'));new vm.Script(source);new vm.Script(engine);
