...
const SERVICES=[
  {
    ...
    landing:{
      en:{headline:"U.S. FTL capacity when your operation cannot wait.",subheadline:"Share your lane and ship date. DGL can review 53' dry van capacity across the U.S. inland network.",supportingCopy:"Full truckload coverage with dedicated equipment, shipment visibility and bilingual support from pickup to delivery.",cta:"REQUEST FTL CAPACITY",seo:{title:"FTL Trucking Capacity in the U.S. | DGL",description:"Request U.S. full truckload (FTL) capacity from DGL. Dedicated 53' dry van coverage, inland lanes and a fast response."},slugBase:"ftl-capacity-usa",utm:{source:"landing",medium:"organic",campaign:"ftl-capacity-usa"}},
      es:{headline:"Capacidad FTL en EE.UU. cuando su operación no puede esperar.",subheadline:"Comparta su ruta y fecha de embarque. DGL revisa capacidad de dry van de 53' en la red terrestre de EE.UU.",supportingCopy:"Cobertura FTL con equipo dedicado, visibilidad del embarque y soporte bilingüe de la recolección a la entrega.",cta:"SOLICITAR CAPACIDAD FTL",seo:{title:"Capacidad de Transporte FTL en EE.UU. | DGL",description:"Solicite capacidad FTL en Estados Unidos con DGL. Cobertura de dry van 53', rutas inland y respuesta rápida."},slugBase:"capacidad-ftl-eeuu",utm:{source:"landing",medium:"organico",campaign:"capacidad-ftl-eeuu"}},
      "pt-BR":{headline:"Capacidade FTL nos EUA quando sua operação não pode esperar.",subheadline:"Envie a rota e a data do embarque. A DGL avalia capacidade de dry van de 53 pés na rede terrestre dos EUA.",supportingCopy:"Cobertura FTL com equipamento dedicado, visibilidade do embarque e suporte bilíngue da coleta à entrega.",cta:"SOLICITAR CAPACIDADE FTL",seo:{title:"Capacidade de Transporte FTL nos EUA | DGL",description:"Solicite capacidade FTL nos Estados Unidos com a DGL. Cobertura de dry van de 53 pés, rotas inland e resposta rápida."},slugBase:"capacidade-ftl-eua",utm:{source:"landing",medium:"organico",campaign:"capacidade-ftl-eua"}}
    },
    creative:{
      en:{headline:"U.S. FTL capacity when your operation cannot wait.",supportingLine:"Dedicated 53' dry van coverage, inland lanes.",cta:"Request Capacity",socialPost:"Need a truck? DGL can review U.S. FTL capacity fast — dedicated equipment, real lanes, real answers.",description:"DGL full truckload coverage across the U.S. inland network.",hashtags:["#FTL","#Trucking","#FreightBroker","#DGL","#Logistics"]},
      es:{headline:"Capacidad FTL en EE.UU. cuando su operación no puede esperar.",supportingLine:"Cobertura dedicada de dry van 53', rutas inland.",cta:"Solicitar Capacidad",socialPost:"¿Necesita un tráiler? DGL revisa capacidad FTL en EE.UU. rápido — equipo dedicado, rutas reales, respuestas reales.",description:"Cobertura de tráiler completo (FTL) de DGL en la red terrestre de EE.UU.",hashtags:["#FTL","#TransporteDeCarga","#FreightBroker","#DGL","#Logistica"]},
      "pt-BR":{headline:"Capacidade FTL nos EUA quando sua operação não pode esperar.",supportingLine:"Cobertura dedicada de dry van de 53 pés, rotas inland.",cta:"Solicitar Capacidade",socialPost:"Precisa de um caminhão? A DGL avalia capacidade FTL nos EUA rápido — equipamento dedicado, rotas reais, respostas reais.",description:"Cobertura de caminhão completo (FTL) da DGL na rede terrestre dos EUA.",hashtags:["#FTL","#TransporteDeCarga","#FreightBroker","#DGL","#Logistica"]}
    }
  },
  {
    id:"LTL",system:"EDITORIAL WHITE",asset:"assets/creative/dgl-ltl-terminal.png",skin:"editorial",
    landing:{
      en:{headline:"Smaller shipment. Same precision.",subheadline:"Ship less than a full trailer with shipment visibility across your U.S. lanes.",supportingCopy:"LTL coverage with consolidated freight handling, shipment tracking and estimated transit windows.",cta:"REQUEST LTL QUOTE",seo:{title:"LTL Freight Shipping in the U.S. | DGL",description:"Request an LTL freight quote from DGL. Less-than-truckload coverage with shipment visibility across the U.S."},slugBase:"ltl-shipping-usa",utm:{source:"landing",medium:"organic",campaign:"ltl-shipping-usa"}},
      es:{headline:"Menos volumen. La misma precisión.",subheadline:"Envíe menos de un tráiler completo con visibilidad del embarque en sus rutas de EE.UU.",supportingCopy:"Cobertura LTL con manejo consolidado de carga, rastreo del embarque y ventanas de tránsito estimadas.",cta:"SOLICITAR COTIZACIÓN LTL",seo:{title:"Transporte LTL en EE.UU. | DGL",description:"Solicite una cotización LTL con DGL. Cobertura de carga parcial con visibilidad del embarque en EE.UU."},slugBase:"transporte-ltl-eeuu",utm:{source:"landing",medium:"organico",campaign:"transporte-ltl-eeuu"}},
      "pt-BR":{headline:"Menor volume. A mesma precisão.",subheadline:"Envie menos que um caminhão completo com visibilidade do embarque nas suas rotas dos EUA.",supportingCopy:"Cobertura LTL com manuseio consolidado de carga, rastreamento do embarque e janelas de trânsito estimadas.",cta:"SOLICITAR COTAÇÃO LTL",seo:{title:"Transporte LTL nos EUA | DGL",description:"Solicite uma cotação LTL com a DGL. Cobertura de carga fracionada com visibilidade do embarque nos EUA."},slugBase:"transporte-ltl-eua",utm:{source:"landing",medium:"organico",campaign:"transporte-ltl-eua"}}
    },
    creative:{
      en:{headline:"Smaller shipment. Same precision.",supportingLine:"Consolidated LTL coverage with shipment visibility.",cta:"Request LTL Quote",socialPost:"Don't need a full trailer? DGL LTL moves your shipment with the same precision — consolidated, tracked, visible.",description:"DGL less-than-truckload coverage across the U.S.",hashtags:["#LTL","#Freight","#SupplyChain","#DGL","#Logistics"]},
      es:{headline:"Menos volumen. La misma precisión.",supportingLine:"Cobertura LTL consolidada con visibilidad del embarque.",cta:"Solicitar Cotización LTL",socialPost:"¿No necesita un tráiler completo? DGL LTL mueve su embarque con la misma precisión — consolidado, rastreado, visible.",description:"Cobertura de carga parcial (LTL) de DGL en EE.UU.",hashtags:["#LTL","#Carga","#SupplyChain","#DGL","#Logistica"]},
      "pt-BR":{headline:"Menor volume. A mesma precisão.",supportingLine:"Cobertura LTL consolidada com visibilidade do embarque.",cta:"Solicitar Cotação LTL",socialPost:"Não precisa de um caminhão completo? A DGL LTL movimenta seu embarque com a mesma precisão — consolidado, rastreado, visível.",description:"Cobertura de carga fracionada (LTL) da DGL nos EUA.",hashtags:["#LTL","#Carga","#SupplyChain","#DGL","#Logistica"]}
    }
  },
  {
    id:"Drayage",system:"ROUTE INTELLIGENCE",asset:"assets/creative/dgl-container-transload.jpg",skin:"route",
    landing:{
      en:{headline:"From port to the next stop, without losing visibility.",subheadline:"Container drayage across major U.S. ports with coordinated inland transload and delivery.",supportingCopy:"Port-to-inland drayage with container tracking, transload coordination and appointment coordination.",cta:"REQUEST DRAYAGE CAPACITY",seo:{title:"Container Drayage Services in the U.S. | DGL",description:"Request drayage capacity from DGL. Port-to-inland container moves with shipment visibility across major U.S. ports."},slugBase:"drayage-services-usa",utm:{source:"landing",medium:"organic",campaign:"drayage-services-usa"}},
      es:{headline:"Del puerto al siguiente punto, sin perder visibilidad.",subheadline:"Drayage de contenedores en los principales puertos de EE.UU. con transload y entrega inland coordinados.",supportingCopy:"Drayage de puerto a inland con rastreo de contenedores, coordinación de transload y coordinación de citas.",cta:"SOLICITAR CAPACIDAD DE DRAYAGE",seo:{title:"Servicios de Drayage de Contenedores en EE.UU. | DGL",description:"Solicite capacidad de drayage con DGL. Movimientos de contenedores de puerto a inland con visibilidad del embarque en los principales puertos de EE.UU."},slugBase:"drayage-eeuu",utm:{source:"landing",medium:"organico",campaign:"drayage-eeuu"}},
      "pt-BR":{headline:"Do porto ao próximo ponto, sem perder visibilidade.",subheadline:"Drayage de contêineres nos principais portos dos EUA com transload e entrega inland coordenados.",supportingCopy:"Drayage de porto a inland com rastreamento de contêineres, coordenação de transload e coordenação de agendamentos.",cta:"SOLICITAR CAPACIDADE DE DRAYAGE",seo:{title:"Serviços de Drayage de Contêineres nos EUA | DGL",description:"Solicite capacidade de drayage com a DGL. Movimentações de contêineres de porto a inland com visibilidade do embarque nos principais portos dos EUA."},slugBase:"drayage-eua",utm:{source:"landing",medium:"organico",campaign:"drayage-eua"}}
    },
    creative:{
      en:{headline:"From port to the next stop, without losing visibility.",supportingLine:"Container drayage across major U.S. ports.",cta:"Request Drayage Capacity",socialPost:"Port to inland, fully tracked. DGL drayage keeps your container moving — and visible — start to finish.",description:"DGL container drayage and inland transload services.",hashtags:["#Drayage","#Container","#PortLogistics","#DGL","#Logistics"]},
      es:{headline:"Del puerto al siguiente punto, sin perder visibilidad.",supportingLine:"Drayage de contenedores en los principales puertos de EE.UU.",cta:"Solicitar Capacidad de Drayage",socialPost:"Del puerto al inland, totalmente rastreado. El drayage de DGL mantiene su contenedor en movimiento — y visible — de principio a fin.",description:"Servicios de drayage de contenedores y transload inland de DGL.",hashtags:["#Drayage","#Contenedores","#LogisticaPortuaria","#DGL","#Logistica"]},
      "pt-BR":{headline:"Do porto ao próximo ponto, sem perder visibilidade.",supportingLine:"Drayage de contêineres nos principais portos dos EUA.",cta:"Solicitar Capacidade de Drayage",socialPost:"Do porto ao inland, totalmente rastreado. O drayage da DGL mantém seu contêiner em movimento — e visível — do início ao fim.",description:"Serviços de drayage de contêineres e transload inland da DGL.",hashtags:["#Drayage","#Conteineres","#LogisticaPortuaria","#DGL","#Logistica"]}
    }
  }
];
