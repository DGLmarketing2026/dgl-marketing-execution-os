...
const PLAYBOOKS=[
  ...
  {id:"ACTIVATION_ACCOUNT",objective:"Activation",purpose:"Open a first commercial conversation with a House-Account priority account and ask what movement is currently on their radar.",messageAngle:"Current Movement",cta:"Send a current route and date to review capacity.",creativeSystem:"DGL Editorial White",sequence:seq([0,6,15],["Ask Current Movement","Capacity / Conditions Follow-Up","Service Value Reminder"])},
...
function getPlaybookForRequest(r){
  ...
  const map={"ACTIVATION":"ACTIVATION_ACCOUNT","RETENTION":"RETENTION_RISK","REACTIVATION":"REACTIVATION_ACCOUNT","CROSS-SELL":"CROSS_SELL_SERVICE","CROSS SELL":"CROSS_SELL_SERVICE","NURTURE":"ACCOUNT_NURTURE","LANE CAMPAIGN":"LANE_CAMPAIGN","RELATIONSHIP RENEWAL":"RELATIONSHIP_RENEWAL","SERVICE CAMPAIGN":"SERVICE_CAMPAIGN"};
